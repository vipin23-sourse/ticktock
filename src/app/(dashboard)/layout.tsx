...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-[#F8F8F8] flex flex-col">
      {/* Top Navigation Bar */}
      <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 sticky top-0 z-10 shrink-0">
      ...
      {/* Main Content Area */}
      <main className="flex-1 w-full max-w-[1328px] mx-auto md:p-6 p-4">
        {children}
      </main>

      {/* Footer */}
      <footer className="w-full mb-6 xl:mb-[74px] py-4 shrink-0">
